...
public class Account{
    ...
    public boolean equals(Account a){
        ...
        if (!this.accountName.equals(a.accountName)) return false;
        if (!this.hash.equals(a.hash)) return false;
        if (!this.salt.equals(a.salt)) return false;
        if (this.verified != a.verified) return false;
        return true;
    }
