...
public class Material implements Expense {
    ...
    public VBox getElem(){
        ...
        Label l2 = new Label("Цена - "+price);
        Label l3 = new Label("Количество - "+amount);
    ...
    public static void CreateElem(FlowPane body, Stage mainStage){
        ...
        TextField t2 = new TextField("Цена");
        TextField t3 = new TextField("Количество");
        ...
        submit.setOnAction(event -> {
            ...
            if(!text2.matches("^[\\d]+(\\.[\\d]+)?$")){
                msg.setText("Цена введена неверно");
            } else if(!text3.matches("^[\\d]+$")){
                msg.setText("Количество введено неверно");
            } else {
        ...
        stage.setTitle("Создание материала");
    ...
    private void edit(VBox elem){
        ...
        submit.setOnAction(event -> {
            ...
            if((!text2.matches("^[\\d]+(\\.[\\d]+)?$")) || (!text3.matches("^[\\d]+$"))){
                msg.setText("Цена или количетво введены неверно");
            } else {
                name = text;
